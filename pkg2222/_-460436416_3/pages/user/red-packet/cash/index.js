...
var a = Object.assign || function(t) {
    ...
    return t;
}, e = t(require("../../../../utils/dg")), n = t(require("../../../../utils/requestUtil")), i = require("../../../../utils/data"), o = (t(i), 
t(require("../../../../utils/listener"))), s = e.default.os.isAlipay(), u = i.duoguan_host_api_url + "/index.php/addon/Wallet";
...
Page({
    ...
    initialize: function(t) {
        var i = this, o = u + "/Api/cashWithdrawal", s = {};
        n.default.get(o, s, function(t) {
    ...
    writeBankAccount: function(t) {
        o.default.addEventListener("wallet.choose.bank.account", function(e) {
    ...
    writeMobile: function(t) {
        o.default.addEventListener("wallet.write.mobile", function(e) {
            0 != e.length && t.setData(a({}, e));
        }), e.default.navigateTo({
    ...
    formSubmit: function(t) {
        ...
        var i = u + "/Api/cashWithdrawal", o = a;
        n.default.post(i, o, function(t) {
