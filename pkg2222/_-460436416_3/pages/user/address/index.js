...
var a = Object.assign || function(e) {
    ...
    return e;
}, i = e(require("../../../utils/dg.js")), s = e(require("../../../utils/requestUtil.js")), r = require("../../../utils/data.js"), n = (e(r), 
e(require("../../../utils/underscore.js"))), o = e(require("../../../utils/listener.js")), d = e(require("../../../utils/util.js")), l = r.duoguan_host_api_url + "/index.php/addon/DuoguanUser";
...
Page({
    ...
    onLoad: function(e) {
        var t = void 0 !== e.isUseLocation && "true" == e.isUseLocation;
        this.setData({
            isCallback: void 0 !== e.isCallback,
            isUseLocation: t
        }), this.setPageTitle("list"), this.initialize(e);
    },
    onUnload: function() {
    ...
    reachBottom: function(e) {
        ...
        s.default.get(a, r, function(a) {
            ...
            0 != (a = a || []).length && (0, n.default)(a).map(function(e) {
                return e;
            }), i = 1 == e.pageNumber ? a || [] : i.concat(a || []), i = (0, n.default)(i).sortBy(function(e) {
                return -e.is_default;
            }), t.setData({
                isShowLoading: !1,
    ...
    radioChange: function(e) {
        ...
        if (!this.data.isCallback) {
            var n = r.id, o = l + "/AddressApi/setDefaultAddress", d = {
                id: n
            };
            return s.default.get(o, d, function(e) {
                t.refresh();
            }, this, {
                isShowLoading: !1
            }), !1;
    ...
    edit: function(e) {
        ...
        var r = {
            id: i
        }, o = l + this.data.url, d = r;
        s.default.get(o, d, function(e) {
        ...
        i.default.chooseLocation({
            ...
            success: function(e) {
                ...
                e.name && (s = e.name), t.setData({
                    ...
                    address: a,
                    detail_info: s
                }), "" == a && i.default.alert("请在补充信息中填写完整的地址"), e.address != e.name || t.data.isAli || d.default.getMapSdk().reverseGeocoder({
                    location: {
                        latitude: e.latitude,
                        longitude: e.longitude
                    },
