...
Component({
    ...
    ready: function() {
        ...
        wx.getSystemInfo({
            success: function(t) {
                console.log(t.model), s.setData({
                    isIpx: t.model.includes("iPhone X"),
                    windowHeight: t.windowHeight - e(50),
                    boardHeigt: e(50)
                });
            }
        });
        var o = this;
        t.userInfoMiddleWare().then(function(e) {
            if (e.isGetUserInfo) {
                var s = t.globalData.userInfo;
                o.setData({
                    avatarUrl: s.avatarUrl
                }, function() {
                    console.log("头像地址为：", o.data.avatarUrl);
                });
            }
        });
    },
