...
Page({
    ...
    onLoad: function(t) {
        ...
        var s = "/page/index/category-list/category-list-pintuan-tab?action=goHome&memberId=" + (wx.getStorageSync("memberCardInfo") && wx.getStorageSync("memberCardInfo").id);
        i.check && (s = "/page/index/category-list/category-list-pintuan-tab?memberId=" + (wx.getStorageSync("memberCardInfo") && wx.getStorageSync("memberCardInfo").id)), 
        console.log("tempShareUrl=", s), this.setData({
            categoryId: null,
            activityType: 2,
            iconName: "拼团",
            tagType: null,
    ...
    loadData: function(a) {
        var s = this, r = a.ReachBottom, l = a.PullDownRefresh, c = this.data, d = c.sort, g = c.collation, h = c.pageIndex, p = c.categoryId, u = c.tagType, m = c.activityType;
