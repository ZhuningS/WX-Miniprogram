...
Page({
    ...
    onLoad: function(t) {
        ...
        var s = "/page/index/category-list/category-list-dzti-tab?action=goHome";
        i.check && (s = "/page/index/category-list/category-list-dzti-tab"), console.log("tempShareUrl=", s), 
        this.setData({
            categoryId: null,
            iconName: "店长推荐",
            tagType: 6,
    ...
    loadData: function(a) {
        var s = this, l = a.ReachBottom, r = a.PullDownRefresh, h = this.data, d = h.sort, c = h.collation, g = h.pageIndex, p = h.categoryId, u = h.tagType;
