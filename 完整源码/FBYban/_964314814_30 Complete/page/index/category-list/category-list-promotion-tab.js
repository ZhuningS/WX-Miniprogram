...
Page({
    ...
    onLoad: function(t) {
        ...
        var s = "/page/index/category-list/category-list-promotion-tab?action=goHome";
        i.check && (s = "/page/index/category-list/category-list-promotion-tab"), console.log("tempShareUrl=", s), 
        this.setData({
            categoryId: null,
            iconName: "促销",
            tagType: 5,
    ...
    loadData: function(a) {
        var s = this, r = a.ReachBottom, l = a.PullDownRefresh, h = this.data, c = h.sort, d = h.collation, g = h.pageIndex, p = h.categoryId, u = h.tagType;
        n.getNewOpenId(function(a) {
            ...
            u && (h.tagType = u), p && (h.categoryId = p), (0, e.DiscoverListM)({
                ele: s,
                data: h,
                PullDownRefresh: l,
                ReachBottom: r,
