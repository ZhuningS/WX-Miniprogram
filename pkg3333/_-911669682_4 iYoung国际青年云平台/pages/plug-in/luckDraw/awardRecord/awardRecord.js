...
var a = t(require("../../../../utils/requestUtil")), e = t(require("../../../../utils/underscore")), o = t(require("../../../../utils/util")), n = require("../../../../utils/data"), i = require("../../../../utils/qrcode");
...
Page({
    ...
    makeCancleCode: function(t) {
        var e = this, o = t.currentTarget.id, i = n.duoguan_host_api_url + "/index.php/addon/MarketingLuckDraw/Api/makeCancelCode";
        a.default.get(i, {
            id: o
        }, function(t) {
            e.setData({
