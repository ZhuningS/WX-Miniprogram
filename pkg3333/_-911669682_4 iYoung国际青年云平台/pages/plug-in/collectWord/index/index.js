...
Page({
    ...
    mywordinit: function(i) {
        var d = this;
        o.post(n.duoguan_host_api_url + "/index.php?s=/addon/MarketingWord/IndexApi/wordIndex.html", i, function(o) {
            d.setData({
                word_hide: !0,
                wordcon: o,
                wid: o.id,
                ...
                d.title = d.data.wordcon.share_title, e.syncUserInfo(function(e, o, i) {
                    var n = "pages/plug-in/collectWord/index/index?userid=" + e.uid;
                    t.default.setShare(d, d.data.options.module, n);
                }), d.lotter_rec();
            }), r.wxParse("description", "html", o.word_content, d);
        });
    },
    lotter_rec: function() {
        var t = this, e = {};
    ...
    onShareAppMessage: function(t) {
        ...
        e.syncUserInfo(function(t, e, o) {
            var n = "/pages/plug-in/collectWord/index/index?userid=" + i.userinfo.uid;
            return i.title = i.data.wordcon.share_title, {
                title: i.title,
                path: n,
                success: function(t) {},
                fail: function(t) {}
