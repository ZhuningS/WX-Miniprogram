...
}(), o = e(require("./underscore.js")), r = e(require("./bluebird.js")), u = e(require("./qqmap-wx-jssdk.min.js")), i = e(require("./dg")), l = e(require("./listener")), s = e(require("./requestUtil")), f = require("./data"), c = function() {
    function e() {
        t(this, e);
    }
    return a(e, null, [ {
        ...
        value: function(t) {
            ...
            var l = new Date();
            l.setMonth(0, 0), l.setHours(0, 0, 0, 0);
            var s = new Date(t);
            return s.setMonth(0, 0), s.setHours(0, 0, 0, 0), l.getTime() === s.getTime() ? e.format(t, "M月d日 hh:mm") : e.format(t, "yyyy年M月d日 hh:mm");
        }
    }, {
        ...
        key: "authUserInfo",
        value: function(e, t) {
            l.default.addEventListener("user.get_info", function n(a) {
                l.default.removeEventListener("user.get_info", n), a && e.call(t, a);
        ...
        value: function(t) {
            e.getUserInfo(function(e) {
                s.default.post(f.duoguan_user_info_post_url, {
                    nickname: e.nickName,
        ...
        value: function(t) {
            ...
            t.page["on" + t.name + "ComfirnTap"] = function() {
                ...
                r = -1 == t ? null : n.data[t];
            }, s.default.get(f.duoguan_host_api_url + "/index.php?s=/addon/Card/CardApi/getMyCoupons.html", o.default.extend({
                available: 1,
                _r: 100
            }, t.params), function(a) {
        ...
        value: function(t, n, a) {
            ...
            u[n] = r, t.setData(u), t["on" + n + "ComfirnTap"] = function() {
                ...
                s.default.get(f.duoguan_host_api_url + "/index.php?s=/addon/Card/CardApi/goCoupon.html", o.default.extend({
                    id: n.id
                }, a), function() {
                    i.default.showToast({
                        title: "领取成功！",
            ...
            }, s.default.get(f.duoguan_host_api_url + "/index.php?s=/addon/Card/CardApi/getCoupons.html", {
                available: 1,
                _r: 100
            }, function(a) {
        ...
        value: function(e, t) {
            ...
            var n = "pay_" + new Date().getTime(), a = function a() {
                l.default.removeEventListener("pay.get_payinfo_" + n, a), l.default.fireEventListener("pay.payinfo_" + n, [ e ]), 
                console.log("pay.payinfo_" + n, "fireEvented");
                l.default.addEventListener("pay.result_" + n, function e(a) {
                    l.default.removeEventListener("pay.result_" + n, e), t && setTimeout(function() {
                        t.call(null, a);
                    }, 500);
                });
            };
            l.default.addEventListener("pay.get_payinfo_" + n, a), console.log("waiting set get_payinfo"), 
            i.default.navigateTo({
                url: "/pages/user/mcard/pay?key=" + n,
                fail: function() {
                    l.default.removeEventListener("pay.get_payinfo_" + n, a), i.default.alert("无法调用余额界面，请尝试关闭一些界面！");
                }
            });
        }
    }, {
        ...
        value: function(e, t) {
            if (e) {
                ...
                l.default.addEventListener("address.choose.confirm", function t(n) {
                    n instanceof Array && (n = {}), l.default.removeEventListener("address.choose.confirm", t), 
                    e.call(null, n);
                });
        ...
        value: function(e, t) {
            if (e) {
                t = 1 == t;
                var n = s.default, a = f.duoguan_host_api_url + "/index.php/addon/DuoguanUser" + "/AddressApi/getDefaultAddress", o = {
                    isUseLocation: t
                };
        ...
        value: function(e, t) {
            ...
            }), l.default.addEventListener("user.mobile.action", function(e) {
                t.call(null, e);
        ...
        key: "receiveCoupon",
        value: function(e, t) {
            var n = "/pages/user/mcard/receive-coupon/receive-coupon" + ("?addon_name=" + (e || "") + "&title=" + (t || ""));
            i.default.navigateTo({
                url: n,
                fail: function(e) {
...
c.syncWechatInfo = c.syncUserInfo, c.trySyncWechatInfo = c.trySyncUserInfo, c.qqMapKeys = [ "YX2BZ-KIACS-NZRO4-6CXHO-EHZ3Z-OCB6U", "AGIBZ-ZVRK4-RFIUB-XLQ3X-UIXPF-K5FS7", "V7BBZ-WXT6J-PQMF4-FFQZB-NVDCH-LKFUY", "EWUBZ-BTZ33-GMW3I-3FYII-XIKM2-DXBAM", "YDUBZ-ZHGC5-D65I6-QKTDH-PBM6E-SGF2M" ], 
exports.default = c, "undefined" != typeof module && (module.exports = c);