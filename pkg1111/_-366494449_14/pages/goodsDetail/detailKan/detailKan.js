...
Page(i.extendPage(o, {
    ...
    onLoad: function(t) {
        ...
        i.initApp({
            loginSuc: function() {
                ...
                var c = r.getMarkAuth(), l = r.getStoreInfo(), m = r.getPay(), g = r.getAuth();
                a.setData({
                    mark_auth: c,
                    companyInfo: l,
                    isLogin: !!r.getUid(),
    ...
    _fetch: function() {
        var t = this, i = this, n = i.data.id, o = r.getUid(), d = i.data.card_id || "", u = i.data.invite || "", c = i.data.channel || "";
        e.P({
            ...
            success: function(e) {
                if (0 == e.code) {
                    var n = e.data.require_address, o = e.data.invite;
                    if (o && "" != o) {
                        r.setCardid(o.id);
                        var d = {
                            cardAvatar: o.avatar,
                    ...
                    var l = e.data, m = l.bargainDetail, g = Math.floor((m.goods_store - m.goods_left) / m.goods_store * 100), h = l.discount / 10;
                    if (i.setData({
                        isNeedAddr: n,
                    ...
                    }), l.content && s.wxParse("article", "html", l.content, t, 0), "1" == l.isbargain) {
                        console.log("砍价"), i._lastTime = l.lasttime;
                        var f = l.bargain_status;
                        i._lastTime <= 0 && (f = 2), t.setData({
                            actType: 1,
                            bargain_status: f,
                    ...
                    var p, _;
                    l.attr.length > 0 ? (console.log("有规格"), p = l.attr, _ = l.attrprice, p[0] && p[0].data[0] && (p[0].data[0].selected = !0), 
                    p[1] && p[1].data[0] && (p[1].data[0].selected = !0), i.setData({
                        dataLoaded: !0,
                        isHasAttr: 1,
                        skuList: p,
                        skuJson: _,
                        num: "1" == l.isbargain ? m.goods_left : l.num,
                        goodsnum: l.num,
                        goodsInfo: l
    ...
    _buy: function(t) {
        ...
        a && void 0 != a && i.updateUserInfo(a), console.log("------------", e), this._showPanel(e);
    },
    ...
    _showPanel: function(t) {
        ...
        e.type = t, a.animation = wx.createAnimation({
            ...
            duration: 200,
            timingFunction: "ease-out"
        }), e.isShow = !0, console.log("------------", e), a.setData({
            panel: e
        }), setTimeout(function() {
    ...
    _kanjia: function() {
        var t = this, i = t.data.bargainDetail.id;
        e.P({
            ...
            success: function(e) {
                if (0 != e.code) return t._closePanel(), void a.showWarn(e.msg);
                var i = e.data;
                t.setData({
                    dataLoaded: !0
                }), t._closePanel(), wx.navigateTo({
                    url: "/pages/bargain/bargain?id=" + i
                });
            }
        });
    },
    ...
    onShareAppMessage: function(t) {
        var a = this, i = r.getUid(), n = r.getCardid(), o = i + "_" + n, s = "/pages/goodsDetail/detailMs/index?id=" + a.data.id + "&invite=" + o;
    ...
    onShow: function() {
        ...
        if ("im" == t.data.fromPage && t.setData({
            ...
            console.log("暂停中");
        }), t._getCartAmount(), !this.data.noshow && "1" == this.data.goodsInfo.isbargain) {
            var i = t.data.id, n = r.getUid(), o = t.data.card_id || "", s = t.data.invite || "", u = t.data.channel || "";
            e.P({
