...
function i(e, t, a, i) {
    ...
    if (0 != d.images.length) {
        var n = d.images, o = r(e.detail.width, e.detail.height, a, i);
        n[t].width = o.imageWidth, n[t].height = o.imageheight, d.images = n;
        var s = {};
        s[i] = d, a.setData(s);
    }
}
...
function r(e, t, a, i) {
    var r = 0, d = 0, n = 0, o = 0, s = {};
    return wx.getSystemInfo({
        success: function(g) {
            var h = a.data[i].view.imagePadding;
            r = g.windowWidth - 2 * h, d = g.windowHeight, e > r ? (n = r, console.log("autoWidth" + n), 
            o = n * t / e, console.log("autoHeight" + o), s.imageWidth = n, s.imageheight = o) : (s.imageWidth = e, 
            s.imageheight = t);
        }
    }), s;
}
...
module.exports = {
    wxParse: function() {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "wxParseData", i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "html", r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : '<div class="color:red;">数据不能为空</div>', o = arguments[3], s = arguments[4], g = o, h = {};
    ...
    wxParseTemArray: function(e, t, a, i) {
        for (var r = [], d = i.data, n = null, o = 0; o < a; o++) {
            var s = d[t + o].nodes;
            r.push(s);
        }
