...
var req = {
    ...
    formTimeSpan: function() {
        for (var e = new Date(), t = {
            ...
            nowHour: e.getHours(),
            nowMin: e.getMinutes()
        }, n = 1990, r = e.getFullYear() + 1; n <= r; n++) t.years.push(n);
            ...
            return regeneratorRuntime.wrap(function(e) {
                for (;;) switch (e.prev = e.next) {
                  ...
                  case 168:
                    ...
                    return e.next = 172, this.downFile(t.Logo.length ? t.Logo[0].url.replace(/^http:/, "https:") + "?x-oss-process=image/resize,l_100,image/circle,r_100/format,png" : "");
    ...
    icon: function(e, t) {
        ...
        return n.sub = !!c, n.shop = !!s, n.share = !!r, n.homeStatus = void 0 == o && 0 != t, 
