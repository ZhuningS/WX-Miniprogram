...
(0, e.newPage)({
    ...
    onShow: function(t) {
        ...
        }), this.whichProduct(), this.setCarCountDot(), t.scene ? 1011 != t.scene && 1047 != t.scene && 1089 != t.scene && 1038 != t.scene && 1017 != t.scene || (this.globalData.officalSceneState = !0) : this.globalData.officalSceneState = !0, 
        console.log("场景值为：", t.scene), console.log("场景状态为：", this.globalData.officalSceneState);
    },
    globalData: {
        ...
        avatarUrl: "",
        nickName: "你的好友",
        shopMHost: "https://mmis-stg1.197.com/",
        pcisHost: "https://pcis-stg1.197.com/",
        newsHost: "https://news-stg1.197.com/",
        host: "https://coupon-stg1.197.com/",
        enableCs: 1,
        ordering_state: 1,
        requestTask: null,
        timerObj: {},
