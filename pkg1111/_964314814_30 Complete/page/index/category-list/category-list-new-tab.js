...
Page({
    ...
    onLoad: function(t) {
        ...
        var s = "/page/index/category-list/category-list-new-tab?action=goHome";
        i.check && (s = "/page/index/category-list/category-list-new-tab"), console.log("tempShareUrl=", s), 
        this.setData({
            categoryId: null,
            iconName: "新品",
            tagType: 1,
    ...
    loadData: function(a) {
        var s = this, l = a.ReachBottom, r = a.PullDownRefresh, h = this.data, c = h.sort, d = h.collation, g = h.pageIndex, p = h.categoryId, u = h.tagType;
