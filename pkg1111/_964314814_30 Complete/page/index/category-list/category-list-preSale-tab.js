...
Page({
    ...
    onLoad: function(t) {
        ...
        var s = "/page/index/category-list/category-list-preSale-tab?action=goHome";
        i.check && (s = "/page/index/category-list/category-list-preSale-tab"), console.log("tempShareUrl=", s), 
        this.setData({
            categoryId: null,
            iconName: "预售",
            tagType: 4,
    ...
    loadData: function(a) {
        var s = this, l = a.ReachBottom, r = a.PullDownRefresh, h = this.data, c = h.sort, d = h.collation, g = h.pageIndex, u = h.categoryId, p = h.tagType;
        n.getNewOpenId(function(a) {
            ...
            p && (h.tagType = p), u && (h.categoryId = u), (0, e.DiscoverListM)({
                ele: s,
                data: h,
                PullDownRefresh: r,
                ReachBottom: l,
    ...
    getBtnText: function(t) {
        ...
        n.getBtnText(function(t) {
            t && a.setData({
                appointmentCopy: t.appointmentCopy,
                purchaseCopy: t.purchaseCopy
            });
        });
    }
});