...
Page({
    ...
    onLoad: function(t) {
        ...
        var s = "/page/index/category-list/category-list-kanjia-tab?action=goHome&memberId=" + (wx.getStorageSync("memberCardInfo") && wx.getStorageSync("memberCardInfo").id);
        i.check && (s = "/page/index/category-list/category-list-kanjia-tab?memberId=" + (wx.getStorageSync("memberCardInfo") && wx.getStorageSync("memberCardInfo").id)), 
