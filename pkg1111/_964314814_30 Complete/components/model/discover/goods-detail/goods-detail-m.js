    ...
    wx.request({
        ...
        success: function(a) {
            ...
            if ("000000" == a.data.code) {
                ...
                r.ele.data.freight = o.freight, 2 == o.isBargain && (r.ele.data.bargainActivityId = o.bargainActivityId ? o.bargainActivityId : 0, 
    ...
    wx.request({
        ...
        success: function(a) {
            ...
            if ("000000" == a.data.code) {
                ...
                r.ele.data.freight = o.freight, o.goodsReserveInfoDto && (r.ele.data.reserveEndTime = o.goodsReserveInfoDto.reserveEndTime, 
                console.log(new Date()), console.log("7546875643856435784358743567", new Date(o.goodsReserveInfoDto.reserveEndTime.replace(/-/g, "/"))), 
                new Date() > new Date(o.goodsReserveInfoDto.reserveEndTime.replace(/-/g, "/")) && (r.ele.data.appointmentExpire = !0)), 
                ...
                (0, n.default)({
                    ...
                    isShowDay: !0,
                    fn: function(e) {
                        console.log("====================   arr=", e), e && r.ele.setData({
                            userPintuanDetailDtos: e
                        });
                    }
                })), r.ele.data.isShowInventory = 2 == parseInt(o.isShowInventory), r.ele.data.isShowSale = 2 == parseInt(o.isShowSale), 
                r.ele.data.viewNum = o.viewNum, o.reserveTime ? (r.ele.data.reserveTime = o.reserveTime, 
                (new Date() > new Date(o.reserveTime.replace(/-/g, "/")) || Math.round(new Date() / 1e3) > Math.round(new Date(o.goodsReserveInfoDto.reserveEndTime) / 1e3)) && (r.ele.data.appointmentExpire = !0)) : r.ele.data.reserveTime = "", 
                o.originalPrice ? (r.ele.data.originalPrice = parseFloat(o.originalPrice / 100), 
                r.ele.data.buyCarDialogInfo.originalPrice = parseFloat(o.originalPrice / 100)) : (r.ele.data.originalPrice = "", 
                r.ele.data.buyCarDialogInfo.originalPrice = ""), r.fn && o.reserveTime) {
                    var l = (0, t.ShowTime)(a.header.Date, "Y-M-D hh:mm:ss", "-"), d = o.reserveTime;
                ...
                r.ele.setData(r.ele.data), (0, n.default)({
                    ...
                    isShowDay: !0,
                    fn: function(e) {
                        console.log("====================   arr=", e), e && (r.ele.data.timeArr = e, r.ele.setData({
                            timeArr: e
                        }));
                    }
                }));
