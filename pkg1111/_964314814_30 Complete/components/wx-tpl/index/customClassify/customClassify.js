...
Component({
    ...
    methods: {
        getGoods: function() {
            var a = this, n = this, s = this.data, r = s.alias, c = s.categoryId, l = {
                openId: i.globalData.openid,
                orgId: i.globalData.orgId,
                pageIndex: 1,
                pageSize: this.data.maxLen
            };
            c ? l.categoryId = c : "bargain" == r ? (l.activityType = 1, l.sort = 6) : "pintuan" == r ? (l.activityType = 2, 
            l.sort = 5) : (console.log("alias===" + r), console.log("isUser====" + n.data.isUser), 
            n.data.isUser ? l.tagType = r : l.tagType = o.indexOf(r) + 1), wx.request({
